...
import net.doo.maps.google.adapter.factory.anymap.LatLngBoundsMapper;
import net.doo.maps.google.adapter.factory.anymap.LatLngMapper;
...
public class AnyMapAdapter {
	...
	private void registerAnyMapToGoogleMappers() {
		registerMapper(
				...
				new net.doo.maps.google.adapter.factory.google.LatLngMapper()
		);
		registerMapper(
				net.doo.maps.model.LatLngBounds.class,
				new net.doo.maps.google.adapter.factory.google.LatLngBoundsMapper()
		);
		registerMapper(
				MarkerOptions.class,
